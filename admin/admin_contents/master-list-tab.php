<?php
    ...
    $student_lists_query = "SELECT * FROM student_grades";
    $student_lists = mysqli_query($con,$student_lists_query);
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/master-list-tab.css">
        ...
        <table>
            <tr class="head">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($student_lists)){
                ?>
