...
<body>
    ...
    <section class="container">
        ...
        <div class="select-status" >
            <ul>
                <li><button id="sel_stat" class="status">Select Status</button></li>          
            </ul>

            <div class="select" id="status_container">
                <div class="regular">Regular</div>
                <div class="irregular">Irregular</div>
            </div>
        </div>
</body>
<script>
    const sel_stat = document.querySelector("#sel_stat");
    const status_container = document.querySelector("#status_container");

    sel_stat.addEventListener("click", function(){
        if(status_container.style.display ==="flex"){
